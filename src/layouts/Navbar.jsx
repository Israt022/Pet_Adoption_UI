          ...
          <div className="flex items-center gap-4">
              <div className="dropdown dropdown-end">
                  <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                      ...
                      <span className="text-yellow-700 indicator-item">{cart?.items?.length || 0}</span>
                      </div>
                  </div>
                  <div
                      tabIndex={0}
              ...
              <div className="relative hidden md:block">
                  ...
                  {showDropdown && (
                      ...
                      <Link to="/dashboard/profile" className="block px-4 py-2 hover:bg-gray-100 text-black">
                        Profile
                      </Link>
                      <a onClick={logoutUser} className="block px-4 py-2 hover:bg-gray-100 text-red-600">Logout</a>
                      </div>
                  )}
              </div>
          </div>) : (
      ...
      {isOpen && (
        <div className="md:hidden bg-white px-4 pb-4 space-y-3 text-gray-700 font-medium">
          ...
          <div>
            <Link 
              to="dashboard" 
              className="block px-2 py-1 rounded hover:bg-gray-100 text-black"
            >
              Dashboard
            </Link>
