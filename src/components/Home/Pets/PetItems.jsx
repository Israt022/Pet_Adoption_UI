  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg p-8 text-center shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer group hover:-translate-y-2">
        ...
        {/* More Info Button */}
        <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-medium px-6 py-2 rounded-full transition-colors duration-300 text-sm uppercase tracking-wide">
          MORE INFO
        </button>
      </div>
    </Link>
